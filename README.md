...
After cloning this repo, simply run `npm install` to get all the packages. From there you can launch the website by running `npm start` and the website will start on port 8080.

You can just copy this and run it in your terminal:
```bash
