let leaderboards = {
  NETWORK: ["NETWORK_NETWORK_LEVEL", "NETWORK_ACHIEVEMENT_POINTS", "NETWORK_KARMA", "NETWORK_QUESTS_COMPLETED", "NETWORK_RANKS_GIFTED", "NETWORK_FIRST_LOGIN"],
  BEDWARS: ["BEDWARS_EXP", "BEDWARS_WINS", "BEDWARS_WLR", "BEDWARS_FINALS", "BEDWARS_FKDR", "BEDWARS_KILLS", "BEDWARS_KDR", "BEDWARS_BEDS", "BEDWARS_BBLR", "BEDWARS_WINSTREAK", "BEDWARS_SOLO_WINS", "BEDWARS_SOLO_WLR", "BEDWARS_SOLO_FINALS", "BEDWARS_SOLO_FKDR", "BEDWARS_SOLO_WINSTREAK", "BEDWARS_DOUBLES_WINS", "BEDWARS_DOUBLES_WLR", "BEDWARS_DOUBLES_FINALS", "BEDWARS_DOUBLES_FKDR", "BEDWARS_DOUBLES_WINSTREAK", "BEDWARS_THREES_WINS", "BEDWARS_THREES_WLR", "BEDWARS_THREES_FINALS", "BEDWARS_THREES_FKDR", "BEDWARS_THREES_WINSTREAK", "BEDWARS_FOURS_WINS", "BEDWARS_FOURS_WLR", "BEDWARS_FOURS_FINALS", "BEDWARS_FOURS_FKDR", "BEDWARS_FOURS_WINSTREAK", "BEDWARS_FOURVFOUR_WINS", "BEDWARS_FOURVFOUR_WLR", "BEDWARS_FOURVFOUR_FINALS", "BEDWARS_FOURVFOUR_FKDR", "BEDWARS_FOURVFOUR_WINSTREAK", "BEDWARS_TICKETS_EARNED", "BEDWARS_COMPLETED_CHALLENGES", "BEDWARS_COLLECTED_EMERALDS", "BEDWARS_COLLECTED_DIAMONDS"],
  DUELS: ["DUELS_WINS", "DUELS_WLR", "DUELS_KILLS", "DUELS_DAMAGE_DEALT", "DUELS_HEALTH_REGENERATED", "DUELS_WINSTREAK", "DUELS_BEST_WINSTREAK", "DUELS_BRIDGE_WINS", "DUELS_BRIDGE_GOALS", "DUELS_SW_WINS", "DUELS_CLASSIC_WINS", "DUELS_UHC_WINS", "DUELS_SUMO_WINS", "DUELS_PARKOUR_WINS", "DUELS_BLITZ_WINS", "DUELS_BOW_WINS", "DUELS_MW_WINS", "DUELS_BOWSPLEEF_WINS", "DUELS_OP_WINS", "DUELS_COMBO_WINS", "DUELS_BOXING_WINS", "DUELS_NODEBUFF_WINS", "DUELS_ARENA_WINS", "DUELS_CLICKS"],
  SKYWARS: ["SKYWARS_EXP", "SKYWARS_WINS", "SKYWARS_WLR", "SKYWARS_KILLS", "SKYWARS_KDR", "SKYWARS_SOLO_NORMAL_WINS", "SKYWARS_SOLO_NORMAL_WLR", "SKYWARS_SOLO_NORMAL_KILLS", "SKYWARS_SOLO_NORMAL_KDR", "SKYWARS_SOLO_INSANE_WINS", "SKYWARS_SOLO_INSANE_WLR", "SKYWARS_SOLO_INSANE_KILLS", "SKYWARS_SOLO_INSANE_KDR", "SKYWARS_TEAM_NORMAL_WINS", "SKYWARS_TEAM_NORMAL_WLR", "SKYWARS_TEAM_NORMAL_KILLS", "SKYWARS_TEAM_NORMAL_KDR", "SKYWARS_TEAM_INSANE_WINS", "SKYWARS_TEAM_INSANE_WLR", "SKYWARS_TEAM_INSANE_KILLS", "SKYWARS_TEAM_INSANE_KDR"],
  PIT: ["PIT_EXP", "PIT_KILLS", "PIT_GOLD", "PIT_KDR", "PIT_DAMAGE_DEALT", "PIT_JOINS", "PIT_PLAYTIME", "PIT_CHAT_MESSAGES", "PIT_CLICKS", "PIT_WHEAT_FARMED"],
  BUILD_BATTLE: ["BUILD_BATTLE_SCORE", "BUILD_BATTLE_WINS", "BUILD_BATTLE_GTB_WINS", "BUILD_BATTLE_GTB_CORRECT_GUESSES", "BUILD_BATTLE_VOTES"],
  MURDER_MYSTERY: ["MURDER_MYSTERY_KILLS", "MURDER_MYSTERY_WINS", "MURDER_MYSTERY_MURDERER_WINS", "MURDER_MYSTERY_DETECTIVE_WINS", "MURDER_MYSTERY_CLASSIC_WINS", "MURDER_MYSTERY_DOUBLE_UP_WINS", "MURDER_MYSTERY_ASSASSINS_WINS", "MURDER_MYSTERY_INFECTION_WINS"],
  TNT_GAMES: ["TNT_GAMES_WINS", "TNT_GAMES_WIZARDS_WINS", "TNT_GAMES_TNTRUN_WINS", "TNT_GAMES_BOWSPLEEF_WINS", "TNT_GAMES_PVPRUN_WINS", "TNT_GAMES_TNTTAG_WINS", "TNT_GAMES_WIZARDS_KILLS", "TNT_GAMES_PVPRUN_KILLS", "TNT_GAMES_TNTTAG_KILLS", "TNT_GAMES_TNTRUN_LONGEST", "TNT_GAMES_PVPRUN_LONGEST"],
  ARCADE: ["ARCADE_DROPPER_BEST_TIME", "ARCADE_DROPPER_WINS", "ARCADE_HYPIXEL_SAYS_WINS", "ARCADE_MINI_WALLS_WINS", "ARCADE_MINI_WALLS_KILLS", "ARCADE_PARTY_WINS", "ARCADE_PIXEL_PARTY_WINS", "ARCADE_THROW_OUT_WINS", "ARCADE_THROW_OUT_KILLS", "ARCADE_ZOMBIES_WINS", "ARCADE_ZOMBIES_KILLS", "ARCADE_ZOMBIES_WINDOWS_REPAIRED", "ARCADE_ZOMBIES_PLAYERS_REVIVED", "ARCADE_ZOMBIES_DOORS_OPENED"],
};
